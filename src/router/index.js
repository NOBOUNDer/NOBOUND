...
const routes=[
  ...
  {path:'/blog/:id?',component: resolve => require(['@/components/blog'],resolve),meta:{title:'My Life 我的生活 | 无边的摄影术'}},
  {path:'/blogClassify/:id?',component: resolve => require(['@/components/blogClassify'],resolve),meta:{title:'My Life 我的生活 | 无边的摄影术'}},
  {path:'/Search/:keyword?',component: resolve => require(['@/components/Search'],resolve),meta:{title:'My Life 我的生活 | 无边的摄影术'}},
