<template>
  <div>
    <div id="Hk" class="container-fluid presentation" :style="{transform:`translateX(${this.store.state.topRight})`,transition:'all .7s ease .2s'}">
      <div class="presentation-top p-0">
        <div class="hk-top-title presentation-top-title row align-items-center">
          <banner/>
        </div>
      </div>
